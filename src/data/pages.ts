...
export const pages: Record<string, PageContent> = {
  home: {
    ...
    blocks: {
      ...
      ctaEyebrow: {
        id: 'Siap membawa tim Anda ke tingkat berikutnya?',
  ...
  about: {
    ...
    heroSubtitle: {
      id: 'Kami didirikan oleh teknisi lapangan, untuk teknisi lapangan — dan untuk perusahaan yang menolak berkompromi soal keselamatan.',
  ...
  training: {
    ...
    metaDescription: {
      id: 'Program pelatihan akses tali RAC: IRATA Level 1, 2, dan 3, sertifikasi BNSP TKPK, refresher, dan pelatihan in-house di lokasi perusahaan Anda.',
  ...
  schedule: {
    ...
    metaDescription: {
      id: 'Jadwal kelas terbuka pelatihan akses tali IRATA Level 1, 2, dan 3, serta sertifikasi BNSP TKPK, lengkap dengan lokasi dan sisa kuota.',
  ...
  faq: {
    ...
    heroSubtitle: {
      id: 'Jawaban langsung atas pertanyaan yang paling sering sampai ke meja kami. Tidak menemukan jawaban Anda? Kirim pesan WhatsApp — kami balas pada hari kerja yang sama.',
